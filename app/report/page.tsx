...
const Report = () => {
  ...
  return (
    <div className="bg-white p-10 w-[90vw] h-[80vh] rounded-lg shadow-md max-w-2xl mx-auto mt-10 text-gray-800">
      <header className="text-center mb-6">
        ...
        />
        <h1 className="text-xl font-bold">Mental Health Clinic Report</h1>
      </header>
      <article className="mb-6">
        <h2 className="text-lg font-bold mb-4">Patient Mood Activity Report</h2>
        <p className="mb-2">
          <strong>Patient Name:</strong> {moodData.name}
        </p>
        <p className="mb-2">
          <strong>Date:</strong> {moodData.date}
        </p>
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            <strong>Stress:</strong> {moodData.stress}%
          </div>
          <div>
            <strong>Happiness:</strong> {moodData.happiness}%
          </div>
          <div>
            <strong>Energy:</strong> {moodData.energy}%
          </div>
          <div>
            <strong>Focus:</strong> {moodData.focus}%
          </div>
          <div>
            <strong>Calmness:</strong> {moodData.calmness}%
          </div>
      ...
      <footer className="text-center mt-8">
        <div className="mb-4">
          <strong>Attending Physician:</strong> {moodData.doctor}
        </div>
        <div className="mb-24">
