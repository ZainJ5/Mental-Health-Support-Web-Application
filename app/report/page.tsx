...
const Report: React.FC = () => {
  ...
  return (
    <>
      <div ref={reportRef} className={`min-h-screen ${darkMode ? 'bg-gray-900' : 'bg-gray-50'} p-6`}>
            ...
            <div className={`border-t ${darkMode ? 'border-gray-700' : 'border-gray-100'} pt-6 mt-8`}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className={`h-12 flex items-center border-b-2 ${darkMode ? 'border-gray-600' : 'border-gray-300'} px-2`}>
                    <span className="italic text-xl text-blue-500">Dr. John Doe</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Fixed download button to generate and download the PDF */}
      <button
        onClick={handleDownload}
        className="fixed bottom-4 right-4 bg-blue-600 text-white p-2 rounded-full shadow-lg hover:bg-blue-700 focus:outline-none"
